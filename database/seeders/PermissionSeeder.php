...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['nombre' => 'rol.file', 'guard_name' => 'rol']);
        ...
        Permission::create(['nombre' => 'logs.file', 'guard_name' => 'logs']);
        ...
        Permission::create(['nombre' => 'users.file', 'guard_name' => 'user']);
        ...
        Permission::create(['nombre' => 'banner.file', 'guard_name' => 'banner']);

        Permission::create(['nombre' => 'popup.list', 'guard_name' => 'popup']);
        Permission::create(['nombre' => 'popup.create', 'guard_name' => 'popup']);
        Permission::create(['nombre' => 'popup.edit', 'guard_name' => 'popup']);
        Permission::create(['nombre' => 'popup.delete', 'guard_name' => 'popup']);
        Permission::create(['nombre' => 'popup.export', 'guard_name' => 'popup']);
        Permission::create(['nombre' => 'popup.import', 'guard_name' => 'popup']);
        Permission::create(['nombre' => 'popup.file', 'guard_name' => 'popup']);
